...
function AppMainContent() {
  ...
  const currentActiveAgents = ['manager', 'work', 'study', 'research']; const workPendingCount = workTasks.filter(t => t.status !== 'completed').length; const studyPendingCount = studyTasks.filter(t => t.status !== 'completed').length;
