...
import { ArrowLeft, ChevronRight, FolderKanban, Plus, Sparkles, Building2, Layers3 } from 'lucide-react';
...
export const WorkViewV2: React.FC<Props> = (props) => {
  ...
  const addProject = () => {
    const title = window.prompt('專案／客戶名稱');
    if (!title?.trim()) return;
